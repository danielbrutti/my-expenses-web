...
describe('Component Tests', () => {
  describe('AccountRecord Management Component', () => {
    let comp: AccountRecordComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AccountRecordComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.accountRecords[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
