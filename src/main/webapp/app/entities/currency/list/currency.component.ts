...
export class CurrencyComponent implements OnInit {
  ...
  constructor(protected currencyService: CurrencyService, protected modalService: NgbModal, protected parseLinks: ParseLinks) {
    this.currencies = [];
    ...
    this.currencyService
      ...
      .subscribe(
        (res: HttpResponse<ICurrency[]>) => {
          ...
          this.paginateCurrencies(res.body, res.headers);
        },
        () => {
          this.isLoading = false;
        }
