...
describe('Component Tests', () => {
  describe('CategoryRule Management Component', () => {
    let comp: CategoryRuleComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CategoryRuleComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.categoryRules[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
