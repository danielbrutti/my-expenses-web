...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'myExpenses';
    ...
    'jhipster.mail.from' = 'myExpenses@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'myExpenses API';
    'jhipster.swagger.description' = 'myExpenses API documentation';
    ...
    'eureka.instance.appname' = 'myExpenses';
    'eureka.instance.instanceId' = 'myExpenses:${random.value}';
